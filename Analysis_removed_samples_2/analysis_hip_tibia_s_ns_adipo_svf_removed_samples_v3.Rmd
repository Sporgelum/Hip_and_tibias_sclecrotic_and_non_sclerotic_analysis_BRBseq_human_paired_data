...
#   method = "cv",
#   number = 5,#changed to 5 from 20
#   classProbs = TRUE)
# 
# tune_grid <- expand.grid(
#   size = (1),#changed from 3:8 #number if hidden neurons
#   #decay = c(0.01,0.1,0.2))
#   decay = c(1,10))
# 
# set.seed(123)
# mod_nnet = caret::train(condition~ .,
#                         data=pp_train,
#                         method = "nnet",
#                         trControl = trcontrol,
#                         tuneGrid = tune_grid,
...
# mean(pred.in.sample != pp_train$condition)
# 
# cMatrixNnet=confusionMatrix(pred,pp_test$condition)
