...
# Remove genes with low variance across all samples
...
library(caret)
```
# Rerun after checking stabilization of oob errors --> with at least 7000 trees.
# TODO here
# check again top genes!
```{r}
# ================================================================
# TRAIN-TEST SPLIT (Patient-wise to avoid data leakage)
# ================================================================
...
# Predict on test set
# =========================
pred_probs <- predict(rf_tuned, newdata = test_data_clean, type = "prob")
...
# 3. Plot the top 20 most important genes
p_importance_gini <- importance_df_gini |> 
  # Arrange by importance and take the top 20
  ...
  labs(
    ...
    subtitle = "Based on Gini Impurity Decrease",
    x = "Genes",
    y = "Importance Score"
  ) +
  theme_minimal()
...
message(paste0("Top50 Gini features:",top_genes))
...
message(paste0("Top50 Accuracy features:",top_genes))
top_genes <- gsub(top_genes,pattern = "\\.",replacement = "-")
valid_genes <- top_genes[top_genes %in% rownames(selected_data)]
heatmap_data <- selected_data[valid_genes, ]
...
```{r}
#oarsi_samples model
saveRDS(rf_tuned, "~/CLUSTER/Environments/2024_07_05_Lea_Lausanne_Hip_Tibia_BRBseq/Analysis_removed_samples_2/trained_models_rf/oarsi_samples_rf_model.rds")
...
logcpm_non_oarsi_data_test <- logcpm_non_oarsi_data[, c("Age","BMI","Gender","oarsi_score",gene_columns)]

# Predict
predicted_labels <- predict(rf_model, logcpm_non_oarsi_data_test)
